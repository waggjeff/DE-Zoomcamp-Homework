...
from settings_multiple import BOOTSTRAP_SERVERS, KAFKA_TOPIC
...
if __name__ == '__main__':
    ...
    json_consumer = JsonConsumer(props=config_g)
    json_consumer.consume_from_kafka(topics=[KAFKA_TOPIC[0]])

    json_consumer = JsonConsumer(props=config_f)
    json_consumer.consume_from_kafka(topics=[KAFKA_TOPIC[1]])
